...
2. Transaction messages following [PSBT standard](https://github.com/bitcoin/bitcoin/blob/master/doc/psbt.md) & [BIP 174](https://github.com/bitcoin/bips/blob/master/bip-0174.mediawiki) : relevant during all swap phases
> [name=Lederstrumpf][color=violet]
`TODO`: decide on whether we actually want to follow the PSBT standard
