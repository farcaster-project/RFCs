 ...
 * The Arbitrating/Accordant blockchain identifier, e.g. BTC-XMR; *Must indentify: blockchain chain and asset traded. E.g. bitcoin on mainnet or bitcoin on testnet. This can be done through a `chain_hash` parameter.*
